...
if (!empty($_SESSION['emailid'])) {
    ...
    $requestsql = "SELECT `id`, `user_id`, `book_id`, `order_date`, `status`, `issued_status`, `issued_date`, `return_date` FROM `request_book` WHERE `user_id` = '$id' AND `return_status` = '0' ";
        ...
        <div class="container content-wrapper">
            <section class="content">
                ...
                <div class="card text-center table-responsive">
                    <div class="card-body">
                        <h3 class="text-center p-2">Received Books</h3> <br>
